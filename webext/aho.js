// Aho-Corasick implementation copied/adapted for web extension usage
class Node {
  constructor(){
    this.next = new Map();
    this.fail = null;
...
if(typeof self !== 'undefined') self.Aho = Aho; else if(typeof module !== 'undefined' && module.exports) module.exports = { Aho };